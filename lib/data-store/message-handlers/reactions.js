...
var toggleReactionForMessage = function toggleReactionForMessage(dataStore, message, isAdded) {
  ...
  if (message) {
    var reactionIndex = findIndex(msgObj.reactions, { name: message.reaction });
...
var handlers = [['reaction_added', partial(toggleReaction, true)], ['reaction_removed', partial(toggleReaction, false)]];
